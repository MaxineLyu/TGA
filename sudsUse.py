...
def createOrgJson(obj, out = {}, parentTrail = '', parentList = False):
    o = out
    if 'Scope' not in parentTrail and 'DeliveryNotification' not in parentTrail and 'ValueCode' not in parentTrail and 'OffsetMinutes' not in parentTrail:
...
def mapHSattr(obj):
    if isCompany(obj):
        a = ['responsiblelegalperson_name', 'organisationlocation_address_line1', 'organisationlocation_address_line2', 'url_link', 'organisationlocation_address_postcode', 'url_startdate', 'organisationlocation_address_countrycode', 'registrationmanagerassignment_startdate', 'registrationmanagerassignment', 'datamanagerassignment', 'datamanagerassignment_startdate', 'responsiblelegalperson_startdate', ]
        b = ['name', 'address', 'address2', 'website', 'zip', 'website_startdate', 'country', 'registrationmanager_startdate', 'registration_manager', 'datamanager', 'datamanager_startdate', 'name_startdate']
    else:
